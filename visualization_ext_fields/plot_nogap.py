...
class fourCamView(object):
    ...
    def __init__(self, cam1):
        ...
        theta = np.array([0+6.*radPerDeg,
            fourCamView.camAngleSep+6.*radPerDeg,\
            2.*fourCamView.camAngleSep+6.*radPerDeg, \
            3.*fourCamView.camAngleSep+6.*radPerDeg]) 
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('nogap.png',dpi=256)
    plt.savefig('nogap.pdf')
