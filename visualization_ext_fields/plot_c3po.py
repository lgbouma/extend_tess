...
class fourCamView(object):
    ...
    def __init__(self, cam1):
        ...
        theta = np.array([-0.5*fourCamView.camAngleSep,
                          0.5*fourCamView.camAngleSep,
                          1.5*fourCamView.camAngleSep,
                          2.5*fourCamView.camAngleSep]) #FIXME
        ## THIS IS FOR A POLE POINTING, PRESUMABLY
...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('c3po.png',dpi=256)
    #plt.savefig('npole.pdf')
