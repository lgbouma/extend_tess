# -*- coding: utf-8 -*-
"""
"idea 13" is the vanilla ecliptic survey option, but splitting the "bonus" 8
orbits between north and south.

this is "idea 1", but shifted in ecliptic longitude and latitude to fill in the
gaps.

it also has 2 orbits per "sector" when viewing the ecliptic, because the SPOC
cannot change a few lines of code to do single-orbit reduction. (absolutely
crazy).
...
def main():
    ...
    df = pd.read_csv("../data/idea_14_final.csv", sep=";")
    ...
    outpath = "../data/idea_14_final_shifted.csv"
