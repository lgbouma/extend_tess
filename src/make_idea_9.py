# -*- coding: utf-8 -*-
"""
run this to make the csv file of "idea 9", which is "idea 1", but shifted in
ecliptic longitude and latitude to fill in the gaps.
...
def main():
    ...
    df = pd.read_csv("../data/idea_1_SN_ecliptic.csv", sep=";")
    ...
    outpath = "../data/idea_9_SNEshifted.csv"
